...
<div style="width: 100%;">
<div style="float: left; margin-right: 50px; margin-bottom:50px; width: 90px; border: 0px solid gray; background-image: url({{ site.url }}{{ site.baseurl }}/images/biogen.jpeg);background-position: center center; background-repeat: no-repeat; background-size: 100% 100%;"> 
</div>
...
<div style="width: 100%;">
<div style="float: left; margin-right: 40px; margin-bottom:10px; width: 100px; border: 0px solid gray; background-image: url({{ site.url }}{{ site.baseurl }}/images/ccw.png);background-position: center center; background-repeat: no-repeat; background-size: 100% 100%;"> 
</div>
...
<div style="width: 100%;">
<div style="float: left; margin-right: 20px; width: 120px; border: 0px solid gray; background-image: url({{ site.url }}{{ site.baseurl }}/images/sbir.png);background-position: center center; background-repeat: no-repeat; background-size: 100% 100%;"> 
</div>
