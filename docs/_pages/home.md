...
<div style="width: 100%;">
<div style="float: left; margin-right: 60px; margin-bottom:50px; height: 30px; width: 90px; border: 0px solid gray; background-image: url({{ site.url }}{{ site.baseurl }}/images/biogen.jpeg);background-position: center center; background-repeat: no-repeat; background-size: 100% 100%;"> 
</div>
