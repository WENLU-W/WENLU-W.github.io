...
- We work on AI-based spatial and temporal predictions.  
	<br>
	<a href=""> <img src="{{ site.url }}{{ site.baseurl }}/images/weather2.png" style="width: 500px; box-shadow: none"></a>
	<br><a href=""> <img src="{{ site.url }}{{ site.baseurl }}/images/weather1.png" style="width: 250px; box-shadow: none"></a>
